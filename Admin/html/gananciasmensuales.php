...
// Consulta para las ganancias mensuales
$query = "SELECT DATE_FORMAT(fechaReserva, '%Y-%m') AS mes, SUM(servicios.precio) AS total_mes
          FROM reservas
...
<body>
    ...
    <div class="navbar_container">
        ...
        <nav class="navbar_menu" id="navbarMenu">
            ...
            <a href="gananciasmensuales.php" class="navbar_link active">Ganancias Mensuales</a>
    ...
    <div class="filters">
        ...
        <button class="filter_button active" data-filter="all">Mensual</button>
    </div>
